...
def check_color(client, bot_e, bot_color):
    b = Actions.color_is_close(client, bot_e, bot_color)
    if not b:
        print('UH OH')
        return False
    return True
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        while True:
            ...
            wait_ticks(9, 0.05)
            if check_color(client, bot_e, (0, 0, 207)):
                break
        ...
        while True:
            ...
            # step 2, 12 ticks min
            wait_ticks(11, 0.05)
            if check_color(client, bot_e, (122, 125, 38)):
                break
        ...
        while True:
            ...
            # step 3, 14 ticks min
            wait_ticks(14, 0.15)
            if check_color(client, bot_e, (208, 0, 0)):
                break
        ...
        while True:
            ...
            # step 4, 7 ticks min
            wait_ticks(5, 0.6)
            if check_color(client, bot_e, (0, 205, 205)):
                break
        ...
        while True:
            ...
            # step 5, 11 ticks min
            wait_ticks(9, 0.05)
            if check_color(client, bot_e, (245, 245, 0)):
                break
        ...
        while True:
            ...
            if check_color(client, bot_e, (0, 105, 252)):
                break
        ...
        while True:
            ...
            Actions.mouse_fidgit(client, bot_a, bot_e)
            wait_ticks(3, 0.3)
            if check_color(client, bot_e, (0, 255, 0)):
                break
        print('LAP DONE')
