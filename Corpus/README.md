# Corpus — Exodia Linux / WSLg port

Living notes for the `feature/linux-exodia-wslg` work. Keep in sync with code changes.

| Document | Purpose |
|----------|---------|
| [exodia_architecture.md](exodia_architecture.md) | Module roles (Exodia “pieces”) and dependency direction |
| [exodia_linux_brain_env.md](exodia_linux_brain_env.md) | `BotBrain`, `window_tool`, `bot_env` / screenshots |
...
**Branch:** `feature/linux-exodia-wslg` (see [git.md](git.md)).
